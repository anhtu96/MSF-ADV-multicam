...
def eval_detection(args=None, save_gif=False):
    if args:
        ...
        for scene in tqdm.tqdm(range(args.num_scenes)):
            ...
            if attack_model.dataset_name == 'argoverse':
                ...
                for cam_num, cam_name in enumerate(attack_model.sensor_names):
                    if cam_name == 'ring_front_center' or cam_name == 'ring_front_right':
        ...
        asr_both = undetected_both / args.num_scenes
        asr_right = undetected_right / args.num_scenes
        asr_center = undetected_center / args.num_scenes
        print(f"Number of scenarios: {args.num_scenes}\n")
